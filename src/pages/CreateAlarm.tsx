            ...
            >
                ...
                <View style={{width: "90%"}}>
                    ...
                    <View style={{
                        ...
                        <Button onPress={() => setOpenDatePicker(true)}>{date.toLocaleDateString('en-GB')}</Button>
                        <DatePickerModal
                            locale="en"
                            mode="single"
                    ...
                    <List.Item
                        title="Repetir"
                        description={alarmBeingCreated ? alarmBeingCreated?.repeat?.map(a => a.substring(0, 2)).join("-") : ''}
                        right={() => <List.Icon icon="chevron-right"/>}
                    ...
                    <TextInput
                        ...
                        onChangeText={description => setAlarmBeingCreated({...alarmBeingCreated, description})}
